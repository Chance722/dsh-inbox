...
> **状态：pre-alpha，M0–M3 已完成。** 东西有两个口能进来，面板里能翻能管（筛选、详情、改类目/描述/标签、已读、回收站），重复项会合并。分类、对话取回、同步还在后面。进度和验收记录在[开发总线](docs/feature/dev-bus.md)。
