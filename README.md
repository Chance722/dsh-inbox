...
| **Ask in conversation** | The assistant searches by words, category, tag, watch-later flag or kind (ten at a time plus a count of the rest, with thumbnails right in the results), and opens one by id (text up to 1000 characters, link, note, tags, attachment facts). 打开 next to a result jumps to that record in the right-hand dock |
