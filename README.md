...
| ✅ Everything has a name | A photo or a file is named by the **file name it arrived with** (`IMG_20260918.jpg`), and with your description that reads `IMG_20260918.jpg（身份证正面）`. Rename it in the detail pane; emptying the field hands the heading back to the file name. A credential keeps its shape — 密钥 / 账密（your name） — with the fixed prefix and your name inside the parentheses |
